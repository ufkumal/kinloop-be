...
public class ActivityEligibilityPolicy {
    public boolean allows(
        ...
        boolean excludeIndependent = adjustment == null || adjustment.getInvolvementFilter() == null
                ? anxious
                : adjustment.getInvolvementFilter() == InvolvementFilter.STRICT;
        if (excludeIndependent && a.getInvolvementType() == InvolvementType.BAGIMSIZ)
            return false;
        return profile.getFocusBand() != FocusBand.SHORT
